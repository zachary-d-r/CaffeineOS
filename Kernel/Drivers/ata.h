...
extern unsigned char detectAta();
extern void initATA(unsigned long addr);
extern void ataPioRead(unsigned long long LBA, unsigned short sectorcount, unsigned char *target);
extern void ataPioWrite(unsigned long long LBA, unsigned short sectorcount, unsigned char *target);
extern unsigned int getBootDevice();